...
const ExportDashboard: React.FC<ExportDashboardProps> = ({ projects, onClose, onDownload, radius, activeTypes }) => {
    ...
    const handleDownloadCSV = () => {
        ...
        const headers = [
            ...
            "Sale Speed (6 เดือน)", "Sale Speed (Total)"
        ];
        ...
        // Sort all projects by Sale Speed 6m (descending) to match the dashboard logic
        const sortedProjectsForExport = [...projects].sort((a, b) => parseFloat(b.saleSpeed6m) - parseFloat(a.saleSpeed6m));
